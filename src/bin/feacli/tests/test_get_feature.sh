...
# expected='
# id,name,group,category,value-type,description,online-revision-id
# 2,model,phone,batch,string,model,<NULL>
# '
# actual=$(feacli get feature phone.model -o csv)
...
# description: model
# '
# actual=$(feacli get feature phone.model -o yaml)
# assert_eq "$expected" "$actual" "$case" 
